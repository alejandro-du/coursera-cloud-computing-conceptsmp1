...
if [ $verbose -eq 0 ]; then
	make clean > /dev/null
	make > /dev/null
	./bin/Application testcases/singlefailure.conf > /dev/null
else
	make clean
	make
	./bin/Application testcases/singlefailure.conf
fi
...
if [ $accuracycount -eq 0 ] && [ $failcount -gt 0 ]; then
	...
	echo "Checking Accuracy..............$accuracycount/10"
fi
echo "============================================"
...
if [ $verbose -eq 0 ]; then
	make clean > /dev/null
	make > /dev/null
	./bin/Application testcases/multifailure.conf > /dev/null
else
	make clean
	make
	./bin/Application testcases/multifailure.conf
fi
joincount=`grep joined ./dbg.log | cut -d" " -f2,4-7 | sort -u | wc -l`
if [ $joincount -eq 100 ]; then
	grade=`expr $grade + 10`
...
if [ $verbose -eq 0 ]; then
	make clean > /dev/null
	make > /dev/null
	./bin/Application testcases/msgdropsinglefailure.conf > /dev/null
else
	make clean
	make
	./bin/Application testcases/msgdropsinglefailure.conf
fi
joincount=`grep joined ./dbg.log | cut -d" " -f2,4-7 | sort -u | wc -l`
if [ $joincount -eq 100 ]; then
	grade=`expr $grade + 15`
...
if [ $failcount -ge 9 ]; then
	...
	echo "Checking Completeness..........$failcount/15"
fi
...
#	echo "Checking Accuracy..............10/10"
#else
#	echo "Checking Accuracy..............$failcount/10"
#fi
#echo "============================================"
